...
namespace BassClefStudio.UWP.Services.Views
{
    ...
    public static class TitleBarService
    {
        ...
        /// </summary>
        public static FrameworkElement TitleBar { get; internal set; }

        /// <summary>
        /// Represents a <see cref="ProgressBar"/> that can display application loading information in the title bar.
        /// </summary>
        public static ProgressBar ProgressControl { get; internal set; }
        ...
        public static void HideTitleBar(FrameworkElement titleBarElement = null, ProgressBar progressControl = null)
        {
